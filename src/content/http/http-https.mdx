...
## Interactive Playground: HTTP Connection Reuse
**Why this matters:** connection reuse directly affects latency and page load performance.

**What to try:** switch between HTTP versions, increase resource count, and observe setup cost changes.
...
# Response (headers only) HTTP/1.1 200 OK

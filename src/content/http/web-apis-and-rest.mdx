...
## Interactive Playground: REST Request Outcomes
**Why this matters:** API correctness depends on method, path, and payload working together.

**What to try:** start from a preset, then change method or path and compare simulated status outcomes.

...
* Better [Search Engine Optimization (SEO)](https://en.wikipedia.org/wiki/Search_engine_optimization) performance, since search engines can [index](https://www.postgresql.org/search/?q=index) static content immediately.
Cons:

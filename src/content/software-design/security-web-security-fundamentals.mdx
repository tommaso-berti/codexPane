...
import SecurityThreatModelPlayground from "./components/security-web-security-fundamentals/SecurityThreatModelPlayground.jsx"
...
Keep these principles in mind as you develop for the web! [OWASP, the Open Web Application Security Project](https://owasp.org/), is a great resource for web developers, offering tools, security education and manuals.

## Interactive Playground: Threat-to-Mitigation Mapping
**Why this matters:** secure design starts by matching threats to concrete controls.

**What to try:** switch threats and confirm the first mitigation layer you would implement.

<SecurityThreatModelPlayground />

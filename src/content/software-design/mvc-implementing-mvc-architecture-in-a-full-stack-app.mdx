---
title: Implementing MVC Architecture in a Full-Stack App
order: 11
---
...
## **Implementing MVC Architecture in a Full-Stack App**
Example available on [https://github.com/tommaso-berti/mvc-architecture-for-full-stack-app-react](https://github.com/tommaso-berti/mvc-architecture-for-full-stack-app-react) Or [https://github.com/tommaso-berti/mvc-to-do-list](https://github.com/tommaso-berti/mvc-to-do-list)
...
```
View        → UI (React) Controller  → Business logic (Express routes + handlers) Model       → Database access (PostgreSQL queries)
...
## Database Layer (Model) PostgreSQL table:
| column       | purpose      |
|--------------|--------------|
...
| created_at   | timestamp    |
 ...
 The model **only communicates with the database**.
It should:
* run SQL queries
* return raw data
...
### Routes (Connecting Controller ↔ Model) Routes map HTTP endpoints to controller functions.
...
## View Layer (React) The React app represents the View.

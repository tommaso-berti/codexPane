---
title: Authentication vs Authorization vs Encryption
order: 1
---

import SecurityDecisionPlayground from "./components/authentication-vs-authorization-vs-encryption/SecurityDecisionPlayground.jsx"
...
## Interactive Playground: Security Decision Map
**Why this matters:** teams often confuse identity checks, permission checks, and data protection.

**What to try:** select each scenario and match it to authentication, authorization, or encryption.

&lt;SecurityDecisionPlayground /&gt;

...
import SessionLifecyclePlayground from "./components/sessions-in-express/SessionLifecyclePlayground.jsx"
...
## Interactive Playground: Session Lifecycle in Express

**Why this matters**  
Session auth bugs usually come from cookie flags, expiry, or stale server state. A lifecycle simulation makes these failure paths easy to reason about.

**What to try**  
Create a session, force expiry, then toggle secure cookie behavior to see how protected-route access changes.

<SessionLifecyclePlayground />

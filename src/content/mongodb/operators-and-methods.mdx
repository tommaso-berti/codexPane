...
// Strings (lexicographic) db.users.find({ lastName: { $lt: "M" } })
~~~
...
## Interactive Playground: Query Matching
**Why this matters:** understanding matching semantics is key to writing precise MongoDB queries.

**What to try:** compare numeric operators, array contains, and dot notation against the same sample data.

import QueryMatchingPlayground from "./components/operators-and-methods/QueryMatchingPlayground.jsx"

<QueryMatchingPlayground />

...
## Interactive Playground: Data Modeling Choice
**Why this matters:** choosing embed vs reference early prevents costly schema and query rewrites later.

**What to try:** switch scenario and access pattern, then compare recommendation and tradeoff checks.

import DataModelingChoicePlayground from "./components/databases/DataModelingChoicePlayground.jsx"

<DataModelingChoicePlayground />

...
import WhiteboardPlanPlayground from "./components/technical-interviews-whiteboarding/WhiteboardPlanPlayground.jsx"
...
## Interactive Playground: Whiteboard Time Allocation
**Why this matters:** interview performance depends on pacing, not only coding speed.

**What to try:** rebalance time toward clarification and testing and observe total slot fit.

<WhiteboardPlanPlayground />

...
## Interactive Playground: Redirection flow
Why this matters: pipes and redirects define where data goes; visualizing the flow prevents command mistakes.
What to try: Change the preset and toggle overwrite/append to observe stdout, file output, and final content.

import RedirectionPlayground from "./components/redirection/RedirectionPlayground.jsx"

<RedirectionPlayground />

---
title: Js Doubly Linked Lists
order: 19
---

# Js Doubly Linked Lists
...
* previous pointer (to the previous node) Because nodes can move both directions, the list keeps both:
* head (first node)
* tail (last node)
...
If you want, I can paste the exact missing block to finish
     removeByData() in the same style as your code.

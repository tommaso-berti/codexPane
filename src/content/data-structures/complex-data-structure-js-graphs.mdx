...
With three classes,
 ...
 , and
     Graph
 , we can implement a variety of [graphs](https://en.wikipedia.org/wiki/Special:Search?search=graphs) that satisfy the requirements of many algorithms. Remember that a
     Graph
  consists of vertices and their corresponding edges.
...
The
     Graph
  class stores and manages the entire network of vertices and edges.
### Properties
| Property                                | Meaning                                 |
|-----------------------------------------|-----------------------------------------|
...
This edge is stored in Atlanta's
     edges
  list.
...
* [GitHub Repo: Graph JS Practice](https://github.com/trekhleb/javascript-algorithms/tree/master/src/data-structures/graph)**Code Challenges**:

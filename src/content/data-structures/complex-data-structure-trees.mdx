...
import TreeTraversalPlayground from "./components/complex-data-structure-trees/TreeTraversalPlayground.jsx"

# Trees

Trees are an essential data structure for storing hierarchical data with a directed flow.
Similar to linked lists and [graphs](https://en.wikipedia.org/wiki/Special:Search?search=graphs), trees are composed of nodes which hold data. The diagram represents nodes as rectangles and data as text.
...
![D2E7D76B-0441-4AEB-BA29-2AB89284AB3B](images/D2E7D76B-0441-4AEB-BA29-2AB89284AB3B.png) Trees grow downwards in computer science, and a *root* node is at the very top. A children is a node referred to a parent. When a node has no children, we refer to it as a *leaf* node.
...
Let's walk through locating the value
     31
 .
...
## Interactive Playground: Tree BFS vs DFS Trace
**Why this matters:** traversal choice changes processing order and problem fit.

**What to try:** run BFS and DFS on the same tree and compare visitation sequence.

<TreeTraversalPlayground />

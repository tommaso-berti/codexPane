...
import HeapifyPlayground from "./components/complex-data-structure-heaps/HeapifyPlayground.jsx"
...
![B702489B-91FC-4247-BE25-915AD7B69D36](images/B702489B-91FC-4247-BE25-915AD7B69D36.png)
...
## Interactive Playground: Heapify Up Trace

**Why this matters**  
Heap operations are fast because they only swap along a parent path. Seeing each swap step makes the `O(log n)` behavior concrete.

**What to try**  
Insert values smaller than the root and compare the number of swaps against values that already satisfy heap order.

...
import QueueFlowPlayground from "./components/linear-data-structure-queues/QueueFlowPlayground.jsx"
...
## Interactive Playground: Queue Flow (FIFO)
**Why this matters:** queue behavior is clearer when enqueue/dequeue are visualized as flow.

**What to try:** enqueue three values, dequeue two, and confirm first in is first out.

...
## Interactive Playground: Overlay Behavior

**Why this matters:** overlays need predictable opening and dismissal behavior to avoid UX friction.

**What to try:** change placement and dismiss strategy, then apply/run actions and inspect event trace.

...
**Why this matters:** many layout bugs come from mixing up main axis and cross axis behavior.

**What to try:** change `flex-direction` first, then compare `justify-content` and `align-items`.

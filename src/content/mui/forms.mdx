...
## Interactive Playground: Form Validation Feedback

**Why this matters:** form quality depends on clear field feedback and a clear global validity state.

**What to try:** type invalid values, run validation, then fix fields and compare output state.

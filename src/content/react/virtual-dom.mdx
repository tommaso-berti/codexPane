...
## Interactive Playground: Diffing and Keys

**Why this matters:** unstable keys can cause unnecessary remounts and confusing UI behavior.

**What to try:** reorder items with stable vs unstable keys and compare the audit output.

...
## Interactive Playground: JSX Outcomes

**Why this matters:** JSX readability comes from understanding exactly how expressions map to rendered UI.

**What to try:** switch JSX pattern, change values, and compare output and checks.

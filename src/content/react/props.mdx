...
## Interactive Playground: Props Flow

**Why this matters:** bugs in React composition often come from unclear prop contracts and callback flow.

**What to try:** leave title empty vs set a custom one, edit children content, and trigger callback trace.

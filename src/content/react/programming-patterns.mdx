...
## Interactive Playground: Container vs Presentational

**Why this matters:** separating stateful logic from rendering logic improves reuse and testability.

**What to try:** toggle state and run actions to inspect parent-to-child data flow.

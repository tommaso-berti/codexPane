...
### **Using Object Destructuring to be more Selective With** require() In many cases, modules will export a large number of data and functions, but only one or two of them are needed in a given file. You can use object destructuring to extract only the needed functions.

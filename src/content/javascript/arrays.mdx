...
~~~js
const nums = [1, 2, 3];
nums[0] = 99;     // ✅ allowed (mutating contents) console.log(nums); // [99, 2, 3]
...
// slice: copy a portion (end not included) const letters = ['a','b','c','d','e'];
...
## Interactive Playground: Array Mutation vs Copy
**Why this matters:** understanding mutation vs copy is essential for predictable state updates.

**What to try:** switch between `slice`, `map`, and `push` to compare before/after results.

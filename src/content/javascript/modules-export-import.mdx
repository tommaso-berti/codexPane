import ModuleResolutionPlayground from "./components/modules-export-import/ModuleResolutionPlayground.jsx"
...
~~~js
// math.js (Node/CommonJS) function add(a, b) { return a + b; }
const PI = 3.14159;
...
~~~js
// app.js (Node/CommonJS) const { add, PI } = require("./math.js");
...
> **Attention**
> This **will not work** (you can’t destructure default members directly in the import):
...
// Default export inline (only one per module) export default function clamp(n, min, max) {
...
## Interactive Playground: Import/Export Resolution

**Why this matters**  
Most module bugs are wiring issues, not syntax complexity. Seeing valid and invalid import combinations helps you debug quickly.

**What to try**  
Switch between named/default import cases and the missing `type="module"` scenario to compare expected outcomes.

<ModuleResolutionPlayground />

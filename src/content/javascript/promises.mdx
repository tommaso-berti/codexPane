...
## Interactive Playground: Promise State Flow
**Why this matters:** promise chains become reliable when you model state transitions explicitly.

**What to try:** run each scenario and advance steps to see where `then` and `catch` execute.

...
## Interactive Playground: Proxy Cache Interception
**Why this matters:** proxies add behavior like caching and logging without changing core objects.

**What to try:** query the same key twice to compare cache miss and cache hit paths.

...
## Interactive Playground: Todo Reducer Updates

**Why this matters:** complex Redux state requires disciplined immutable updates for correctness.

**What to try:** add todos, change filter, and toggle first visible item to inspect update behavior.

...
## Interactive Playground: Reducer Action Flow

**Why this matters:** reducer logic is only reliable when action effects are predictable and traceable.

**What to try:** dispatch add and clear actions, then compare how state transitions are reflected.

...
Ubuntu is a popular Linux distribution based on Debian. It uses the Linux kernel, GNU tools, and APT for package management. You’ll mostly interact with it via the shell (bash) over SSH on a VPS.
...
## Interactive Playground: chmod converter

**Why this matters:** Linux permission mistakes can break deployment and expose sensitive files.

**What to try:** apply `644`, `755`, and `600` to compare symbolic flags and command output.

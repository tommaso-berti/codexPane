...
# Allow web traffic (HTTP/HTTPS) sudo ufw allow 80/tcp
...
# System logs (most recent with context) sudo journalctl -xe
...
# Power off (you will need to power it back on from your provider panel, e.g., IONOS) sudo poweroff
~~~

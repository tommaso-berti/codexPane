...
![792971EC-8992-4ACA-8AF6-4C43FDD0729C](images/792971EC-8992-4ACA-8AF6-4C43FDD0729C.png) Like any other of the computer’s shared hardware resources, the OS must protect memory so that rogue processes cannot disrupt the computer’s (and the other processes running on it) ability to run. Consider that the operating system itself exists in memory.
...
## Paging
## ![4D1E4E14-8A94-4F3A-BF31-79049BEDFB05](images/4D1E4E14-8A94-4F3A-BF31-79049BEDFB05.png) Recall that, as memory is allocated and freed using segmentation, the size of contiguous blocks of free memory tends to decrease. In other words, our memory becomes fragmented.

...
## Locking (mutex) Our program from the last exercise failed because multiple threads were allowed to access
     x
...
## Condition Variables
![1283C7CE-7DA6-4F42-80E5-0A47DC0C158C](images/1283C7CE-7DA6-4F42-80E5-0A47DC0C158C.png) We create two threads representing a maker and a seller. When the maker thread calls make_guitar(), the num_guitars variable is incremented. When seller thread calls sell_guitar(), num_guitars is decremented as long as num_guitars is greater than 0.

import BranchWorkflowPlayground from "./components/git-flow/BranchWorkflowPlayground.jsx"
...
## Interactive Playground: Branch Workflow

**Why this matters**  
Most integration issues come from running Git steps out of order.

**What to try**  
Apply branch, commit, rebase, and merge steps sequentially and inspect the mini history graph.

<BranchWorkflowPlayground />

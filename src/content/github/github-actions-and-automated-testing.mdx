import WorkflowTriggerPlayground from "./components/github-actions-and-automated-testing/WorkflowTriggerPlayground.jsx"
...
1. Create `.github/workflows/unittests.yaml` with:
...
## Interactive Playground: Workflow Triggers

**Why this matters**  
Workflow triggers and job selection define CI cost, speed, and deployment safety.

**What to try**  
Adjust trigger, branch pattern, and jobs, then verify the workflow checks summary.

<WorkflowTriggerPlayground />

...
import UndoSafelyPlayground from "./components/backtrack/UndoSafelyPlayground.jsx"
...
## Interactive Playground: Undo Safely

**Why this matters**  
Undo commands can target different Git layers and have very different risk levels.

**What to try**  
Compare `restore`, `reset --soft`, `--mixed`, and `--hard`, then observe the impact matrix.

<UndoSafelyPlayground />

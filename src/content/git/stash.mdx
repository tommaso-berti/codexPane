...
import StashWorkflowPlayground from "./components/stash/StashWorkflowPlayground.jsx"
...
## Interactive Playground: Stash Workflow

**Why this matters**  
Stash is powerful when you need context switching, but behavior changes with `-u`, patch mode, and apply/pop.

**What to try**  
Create stashes with different options, then compare restoring with `apply` versus `pop`.

<StashWorkflowPlayground />

...
## Interactive Playground: Button States

**Why this matters**  
Buttons must communicate clickability and keyboard focus consistently across variants.

**What to try**  
Switch variant and state, then check whether the action still looks clearly interactive.

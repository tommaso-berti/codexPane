...
## Interactive Playground: Specificity Winner

**Why this matters**  
Most CSS conflicts come from not knowing why one selector wins over another.

**What to try**  
Compare two rules, then change source order in tie cases and watch the winner update.

import SpecificityPlayground from "./components/specificity/SpecificityPlayground.jsx"

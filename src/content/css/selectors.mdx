...
## Interactive Playground: Selector Matching

**Why this matters**  
Selectors become easier when you can immediately verify what gets matched.

**What to try**  
Change selector presets and DOM scenarios, then observe which elements are highlighted.

import SelectorsPlayground from "./components/selectors/SelectorsPlayground.jsx"

...
## What is SQL?
SQL (**S**tructured **Q**uery **L**anguage) is a [programming language](https://www.postgresql.org/search/?q=programming+language) used to communicate with data stored in a relational database management system. SQL syntax is similar to the English language, which makes it relatively easy to write, read, and interpret.
...
For more information about PostgreSQL including installation instructions, read [this](https://www.postgresql.org/search/?q=this) article.
...
For more info on SQLite, including installation instructions, read [this](https://www.postgresql.org/search/?q=this) article.

# 2. Infrastructure Traditional Infrastructure
...
### **Staging**
The **staging** environment is an environment that attempts to match production as closely as possible in terms of resources used, including <u>[computational load](https://en.wikipedia.org/wiki/Load_(computing))</u>, hardware, and architecture. This means that when an application is in staging, it should be able to handle the amount of work it is expected to be doing in production. In some cases, an organization may choose to employ a period when the project is used internally (often referred to as <u>[“dogfooding”](https://en.wikipedia.org/wiki/Eating_your_own_dog_food)</u>) before moving to production.
...
Depending on how a company wants to release their project, <u>[deployment strategies](https://harness.io/blog/blue-green-canary-deployment-strategies/)</u> can greatly differ. Some examples of deployment strategies include:

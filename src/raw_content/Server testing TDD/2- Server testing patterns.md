...
In the web app that we’ve built in this lesson, we’ve placed the templates in the  <span style="font-family: .AppleSystemUIFontMonospaced-Regular; font-size: 12.0;text-align: left;">
     /views
 </span> folder and have an extension of  <span style="font-family: .AppleSystemUIFontMonospaced-Regular; font-size: 12.0;text-align: left;">
     .handlebars
 </span>. Our controller will now use  <span style="font-family: .AppleSystemUIFontMonospaced-Regular; font-size: 12.0;text-align: left;">
     .render()
 </span> to create the view and pass in any variables:

...
* Every action must have a type property with a <u>[string](https://www.codecademy.com/resources/docs/general/data-types/string)</u>Preview: Docs Loading link description value. This describes the action.
...
* We use the equals sign = to <u>[supply a default value](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Default_parameters)</u> for the state <u>[parameter](https://www.codecademy.com/resources/docs/general/parameter)</u>We use <u>[the spread operator (...)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax)</u> to copy the current state and any changed values into a new object, not the existing state <u>[argument](https://www.codecademy.com/resources/docs/general/argument)</u>. We’ll explain why in the next exercise.

### **Rules of Reducers**
In the previous exercise, we wrote reducers that returned a new copy of the state rather than editing it directly. We did this to adhere to the <u>[rules of reducers provided by the Redux documentation](https://redux.js.org/tutorials/fundamentals/part-3-state-actions-reducers#rules-of-reducers)</u>:
...
[F875CECA-5BB8-4E3A-AEC1-2DC151B69AE6](attachments/F875CECA-5BB8-4E3A-AEC1-2DC151B69AE6.mov)

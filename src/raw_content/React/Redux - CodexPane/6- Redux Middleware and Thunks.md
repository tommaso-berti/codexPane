...
[C3099B6C-9999-452D-ACFE-A2F332489293](attachments/C3099B6C-9999-452D-ACFE-A2F332489293.mov)
...
Middlewares must conform to a specific, nested function structure in order to work as part of the pipeline (this nested structure is also called a <u>[higher-order function](https://eloquentjavascript.net/05_higher_order.html)</u>, if you’d like to read more). That structure looks like this:
...
## **Using createSlice() with Async Action Creators (extraReducers)**

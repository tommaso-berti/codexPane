...
Stacks, a data structure, follow a strict <u>[protocol](https://www.codecademy.com/resources/docs/general/protocol)</u> for the order data enters and exits the structure: **the last thing to enter is the first thing to leave**.

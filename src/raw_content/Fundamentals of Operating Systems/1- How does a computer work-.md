...
The input device’s job is to detect and report any type of event; for example, a mouse can sense the action of being clicked. Once an event is received by the input device, it reacts by sending information to the <u>[CPU](https://www.codecademy.com/resources/docs/general/computer-hardware/cpu)</u>. In order to properly “speak” with the CPU, information needs to be communicated using <u>[binary](https://www.codecademy.com/resources/docs/general/binary)</u> code which are instructions composed of 0s and 1s.
Once the input is converted into binary, it is sent to the CPU to be processed.

## **Processing**
The job of processing information is given to the central processing unit, or <u>[CPU](https://www.codecademy.com/resources/docs/general/computer-hardware/cpu)</u>
...
### **Primary Memory**
When a command to run a program is sent to the <u>[CPU](https://www.codecademy.com/resources/docs/general/computer-hardware/cpu)</u>, the CPU retrieves data from Random Access Memory, or RAM, in order to access what instructions it needs to execute. Accessing data from RAM is significantly faster than accessing data from other memory systems.

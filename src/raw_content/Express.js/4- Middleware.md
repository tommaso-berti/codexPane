...
If we look at our bodyParser, we see a simplified version of how one might perform request body parsing. Take a look at <u>[body-parser](https://github.com/expressjs/body-parser#body-parser)</u>. “Node.js body parsing middleware”, that’s just what we needed! Let’s see if we can use this *dependency* instead of trying to manage our own body-parsing logic.

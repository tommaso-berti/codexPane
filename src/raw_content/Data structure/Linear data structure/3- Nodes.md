...
Nodes are the fundamental building blocks of many computer science <u>[data structures](https://www.codecademy.com/resources/docs/general/data-structures)</u>. They form the basis for linked lists, stacks, queues, trees, and more.
...
In the previous example, the node contained an integer ( <span style="font-family: .AppleSystemUIFontMonospaced-Regular; font-size: 12.0;">
     5
 </span>), but it could also contain:
* A **string** (e.g., "five")
* A **decimal number** (e.g., 5.1)
* An **array** (e.g., [5, 3, 4])
* Or **nothing** (null)
This shows that nodes are flexible containers capable of holding many kinds of data.
...
In other words, a  <span style="font-family: .AppleSystemUIFontMonospaced-Regular; font-size: 12.0;">
     null
 </span> link indicates that there are no more connected nodes in that direction.
